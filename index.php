...
<div class="boxes">
    <img src="cold-coffee-with-ice-cream-1.webp" alt="Cold-Coffee with Ice-cream"></div>
    <div class="text">
        <h3>Flat White</h3>
...
<div class="boxes">
    <img src="imagesi.jpeg" alt="Capppuccino"></div>
    <div class="text">
        <h3>Capppuccino</h3>
...
<div class="boxes">
    <img src="imagesd.jpeg" alt="Espresso"></div>
    <div class="text">
        <h3>Espresso</h3>
...
<div class="boxes">
    <img src="imagesa.jpeg" alt="Macchiato"></div>
    <div class="text">
        <h3>Macchiato</h3>
...
<div class="boxes">
    <img src="imagesj.jpeg" alt="Frappe"></div>
    <div class="text">
        <h3>Frappe</h3>
...
<div class="boxes">
    <img src="Caramel-Macchiato-1.jpeg" alt= "Caramel Macchiato"></div>
    <div class="text">
