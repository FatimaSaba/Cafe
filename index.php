...
<section class="container1">
    ...
    <div class="split-left-img" >
     <img src="./resources/img/home.jpeg" alt="coffee image" wight="200" height="600">
    </div>

    <div class="split-right-para">
    <p>
...
<div class="mboxes">
    ...
    <img src="./resources/img/Macchiato.jpg" alt="Macchiato"></div>
    <div class="text">
        <h3>Macchiato</h3>
<div class="stars">
...
<div class="mboxes">
    ...
    <img src="./resources/img/cafe mocha.jpg" alt="cafe mocha"></div>
    <div class="text">
        <h3>Cafe Mocha</h3>
<div class="stars">
...
<div class="mboxes">
    ...
    <img src="./resources/img/espresso.webp" alt="Espresso"></div>
    <div class="text">
        <h3>Espresso</h3>
<div class="stars">
...
<div class="mboxes">
        <span class="price">$4</span>
    <img src="./resources/img/americano.jpeg" alt="americano"></div>
    <div class="text">
        <h3>Americano</h3>
<div class="stars">
...
<div class="mboxes">
        <span class="price">$8</span>
    <img src="./resources/img/irish.jpg" alt="Irish Coffee"></div>
    <div class="text">
        <h3>Irish Coffee</h3>
<div class="stars">
...
<div class="mboxes">
    ...
    <img src="./resources/img/coldcoffeewithicecream.jpg" alt="Cold-Coffee with Ice-cream"></div>
    <div class="text">
...
<div class="mboxes">
        <span class="price">$8</span>
    <img src="./resources/img/latte.jpg" alt="Latte"></div>
    <div class="text">
        <h3>Latte</h3>
<div class="stars">
...
<div class="mboxes">
        <span class="price">$10</span>
    <img src="./resources/img/frappe.jpg" alt="Frappe"></div>
    <div class="text">
        <h3>Frappe</h3>
...
<div class="speciality" id="speciality">
    <h1 class= "heading"><span>Speciality</span></h2>
</div>
<div class="boxes">
    <img src="./resources/img/imagesf.jpeg" alt="flat white"></div>
    <div class="text">
